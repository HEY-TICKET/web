...
import ShareModal from 'deprecated/features/category/performance/ShareModal';
import { CouponIcon, HeartIcon, HeartLineIcon, ShareIcon } from 'deprecated/styles/icons';
